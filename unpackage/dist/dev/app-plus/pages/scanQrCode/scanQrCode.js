...
(() => {
  ...
  // F:/work/ChuangDian/unpackage/dist/dev/.nvue/pages/scanQrCode/scanQrCode.js
      ...
      (0, import_vue2.createElementVNode)("view", {
        ...
        (0, import_vue2.createElementVNode)("view", { style: { "width": "750rpx", "position": "absolute", "bottom": "0rpx", "display": "flex", "flex-direction": "column", "justify-content": "center", "align-items": "center" } }, [
          (0, import_vue2.createElementVNode)("view", {
            ...
            (0, import_vue2.createElementVNode)("u-text", null, "\u641C\u7D22\u8BBE\u5907 ")
          ]),
          (0, import_vue2.createElementVNode)("view", {
  ...
  if (webview) {
    ...
    const __pagePath = "pages/scanQrCode/scanQrCode";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    scanQrCode.mpType = "page";
    const app = Vue.createPageApp(scanQrCode, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...scanQrCode.styles || []]));
    app.mount("#root");
  }
})();
